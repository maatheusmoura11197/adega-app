    ...
    if nome and telefone and conexao:
        try:
            with st.spinner('A processar...'):
                ...
                # --- 2. MENSAGENS COM CÓDIGOS UNIVERSAIS (UNICODE) ---
                # Usamos \U... para garantir que o emoji funciona até na Lua 🌑
                ...
                # 3. CRIAÇÃO DO LINK BLINDADO
                # Usamos quote_plus (melhor para URLs) e o link api.whatsapp.com (mais estável que wa.me)
                msg_link = urllib.parse.quote_plus(msg_texto)
